        ...
        >
         <h1 className="text-6xl md:text-8xl font-mono mb-4 text-center text-shadow-md text-shadow-black text-white">Easy Tour Management... Are You Ready?
          ...
          <div className="space-x-4 text-center">
            ...
            <Link href="https://bandpracticecrm.com/auth/signin">
            ...
            <span className="bg-black p-4 border-red-600 border-2 text-white text-shadow-sm text-shadow-blur-1 text-shadow-black">
              Band Practice CRM Available Soon!
            </span>
          </div>
        </motion.div>
      </div>
